...
LOG_FILE = os.path.join(WS, "logs/hpc_qwen_eval_log.txt")
...
MAX_MODEL_LEN = 8192 #32768  # Qwen3.5-397B context length
MAX_CHUNK_CHARS = 100_000  # Increased for large context window
BATCH_SIZE = 32  # Reduced batch size for 397B model (memory constraints)
...
def main():
    ...
    try:
        ...
        logger("vLLM initialized successfully on 4× H100 GPUs with AWQ quantization.")
    except Exception as e:
